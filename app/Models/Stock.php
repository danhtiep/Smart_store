...
class Stock extends Model
{
    ...
    protected $fillable = ['name','stock_code','quote_code','attribute_value','attribute','meta_keyword','reorder_qty','description','review_num','rating_num','expired_date','min_order_allow','max_order_allow','qty','cost','discount','status','image','category_id','currency_id','stock_uom_id','store_id','condition_id'];
