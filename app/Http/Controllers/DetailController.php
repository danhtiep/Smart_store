...
use DB;
use App\Models\AttributeValue as AttributeValues;
...
class DetailController extends Controller
{
    ...
    function index($id){
        ...
        $Attribute_values_by_id = AttributeValues::where('id',$stock_detail->attribute_value)->get();
        return view('layouts.frontend.partials.detail',['stock_detail'=> $stock_detail,'imageDetail'=>$imageDetail,'stock_cate'=>$stock_cate,'imageStock'=>$imageStock,'related_stock'=>$related_stock,'Attribute_values_by_id'=>$Attribute_values_by_id,'Attribute'=>$Attribute,'info'=>$info]);
    }
