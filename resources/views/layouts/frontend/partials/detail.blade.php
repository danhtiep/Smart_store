                                ...
                                <div class="detail-info">
                                    ...
                                    <div class="attr-info">
                                        ...
                                        foreach ($Attribute_values_by_id as $v){
                                                    ...
                                                    <div class="attr-product">
                                                        ...
                                                        foreach ($Attribute as $v){
                                                            ...
                                                            <td>
                                                            <select class="attri" data-placeholder="Select" tabindex="8" name="<?php echo $v->id; ?>[]" >
                                        ...
                                        ?>
                                                ...
                                                <a class="addcart-link" href="{{url('/cart/addToCartDetail')}}/<?php echo $stock_detail->id; ?>"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
                                            ...
                                            <div class="item-product">
                                                <div class="product-thumb">
                                                    ...
                                                    <div class="product-info-cart">
                                                        ...
                                                        <a class="addcart-link" href="{{url('/cart/addToCartDetail')}}/<?php echo $item_stock_cate->id; ?>"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
                                                    </div>
                                                </div>
