                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="sort-pagi-bar">
                                                    ...
                                                    <div class="product-pagi-nav">
                                                        @if($stock_cate->currentPage() != 1)
                                                        <a href="{!! str_replace('/?','?',$stock_cate->url($stock_cate->currentPage() - 1)) !!}">Prev <i class="fa fa-angle-double-left"></i></a>
                                                        @endif
                                                        @for ($i = 1 ; $i <= $stock_cate->lastPage() ; $i = $i + 1)
                                                        <a class="{!! ( $stock_cate->currentPage() == $i) ? 'active' : '' !!}" href="{!! str_replace('/?','?',$stock_cate->url($i)) !!}">{!! $i !!} </a>
                                                        @endfor
                                                        @if($stock_cate->currentPage() != $stock_cate->lastPage())
                                                        <a href="{!! str_replace('/?','?',$stock_cate->url($stock_cate->currentPage() + 1)) !!}" class="next">next <i class="fa fa-angle-double-right"></i></a>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="item-product">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                                            ...
                                                            <p class="product-desc">{{ $item_stock_cate->description }} </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                        ...
                        <div class="sidebar-shop sidebar-left">
                            <div class="widget widget-filter">
                                <div class="box-filter category-filter">
                                    ...
                                    <ul>
                                    <?php $categories = DB::table('categories')->take(5)->orderBy('name','DESC')->get(); ?>
