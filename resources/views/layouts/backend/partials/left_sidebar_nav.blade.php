            ...
            <nav class="navigation">
                <ul class="list-unstyled">
                    ...
                    <li class="has-submenu {{ (Request::url() == route('admin.category')) ? 'active' : '' }}">
                            <a href="{{route('admin.category')}}"><i class="fa fa-bars"></i> Category<span class="fa arrow"></span></a>
                    </li>
                    <li class="has-submenu {{ (Request::url() == route('admin.attributes')) ? 'active' : '' }}">
                            <a href="{{route('admin.attributes')}}"><i class="fa fa-bars"></i> Attribute<span class="fa arrow"></span></a>
                    </li>
                    <li class="has-submenu {{ (Request::url() == route('admin.attributes-value')) ? 'active' : '' }}">
                            <a href="{{route('admin.attributes-value')}}"><i class="fa fa-bars"></i> Attribute Value<span class="fa arrow"></span></a>
                    </li>
